...
# ---------------------------------------------------------------------------
PATHS = {
    "instances_dir": r"Your\Path\To\Instances",
    "solutions_dir": r"Your\Path\To\Solutions",
    "model_weights": r"Your\Path\To\Model\Weights",
    "log_file":      r"Your\Path\To\Log\File",
}
...
OUTPUT = {
    ...
    "metrics_csv_path":  r"Your\Path\To\Metrics\CSV",
